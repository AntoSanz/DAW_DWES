-- 1. Crear la BBDD
create database daw_dwes_03_ejercicio DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- Seleccionar la base de datos creada
use daw_dwes_03_ejercicio;
...
-- 4.- Le damos permiso en la base de datos "daw_dwes_03_ejercicio" 
grant all on daw_dwes_03_ejercicio.* to gestor@'localhost';